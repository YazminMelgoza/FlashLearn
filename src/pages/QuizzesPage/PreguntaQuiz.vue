  ...
  <div v-else class="h-full flex flex-col items-start justify-start">
    ...
    <div v-else class="h-full w-full">
      ...
      <div class="relative w-full h-[9%] flex justify-center items-center">
        ...
        >
          <div
            class="absolute h-full transition-all ease-in-out duration-300 flex flex-row bg-primary-botonañadir rounded-3xl"
            :style="{
              width: (currentFlashcardIndex / flashcards.length) * 100 + '%'
            }"
          ></div>
          <div
            class="absolute w-1/12 transition-all ease-in-out duration-300 bg-primary-botonañadir h-[140%] rounded-xl shadow-2xl :"
            :style="{
              marginLeft:

...
<template>
  ...
  <div class="w-1/2 h-[50%] flex flex-col justify-start items-start align-start">
      <router-link to="quiz">
  <IndivQuiz />
      </router-link>
  <IndivQuiz />
    </div>
    <titulo class="flex w-full justify-start text-stone-950 text-2xl pt-12 font-bold">
      Terminados
    </titulo>
    <terminados class="flex w-full h-1/5 flex-rowjustify-start items-start">
      <TermQuiz />
      <TermQuiz />
      <TermQuiz />
    </terminados>
